...
<head>
    ...
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.7.2/css/all.css" integrity="sha384-fnmOCqbTlWltjvTw2x04yRrhIR3I7h7RDiJ9NKhKhMP1lDGGsvR" crossorigin="anonymous">
    <!-- DataTable -->
            ...
            $("#simpan").click(function() {
                ...
                if (
                    ...
                    $.ajax({
                        ...
                        data: data,
                        success: function() {
                            $(".data").load("data.php"); // reload table
